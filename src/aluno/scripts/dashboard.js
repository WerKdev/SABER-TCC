...
document.addEventListener("DOMContentLoaded", function() {
    ...
    let performanceChart, distributionChart, attendanceChart, skillsRadarChart;
    ...
    // Toggle menu mobile com overlay
    if (menuIconMobile) {
    ...
    if (notificationsIcon && notificationsPopup) {
        notificationsIcon.addEventListener("click", function(event) {
            ...
            // Fechar o outro popup se estiver aberto
            if (userIconPopup) userIconPopup.style.display = "none";
